...
#### 🔍 손실 함수와 옵티마이저
1. MSE: 평균 제곱 오차
   <img width="400" height="60" alt="image" src="https://github.com/user-attachments/assets/8f0ae438-261c-494c-bb5c-aa233689d235" />
2. Cross Entropy: 분류 문제에서 사용되는 손실 함수로 모델의 예측 확률과 실제 정답 간의 차이를 측정함
   <img width="550" height="60" alt="image" src="https://github.com/user-attachments/assets/4f667889-9e6c-4e44-a153-1a79f9f6e34a" />
